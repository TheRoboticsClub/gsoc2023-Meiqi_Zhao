...
from agent import NoisyBehaviorAgent
...
def main(params):
    ...
    while episode_cnt < params.n_episodes:
        ...
        agent = NoisyBehaviorAgent(vehicle, behavior='normal')
        ...
        while True:
            ...
            if control.brake == 1.0 and agent.done(): # target reached, discard last frame
                continue
